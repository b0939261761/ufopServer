...
export const up = knex => knex.raw(`
  ...
  CREATE INDEX "Organizations_createdAt_idx" ON "${tableName}" USING btree ("createdAt");
  CREATE INDEX "Organizations_isNewUsrInfo_idx" ON "${tableName}" USING btree ("isNewUsrInfo");
